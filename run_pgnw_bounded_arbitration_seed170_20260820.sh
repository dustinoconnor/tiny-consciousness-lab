...
run_memory="outputs/resource_memory_pgnw_bounded_arbitration_seed170_20260820.json"
typed_memory="outputs/typed_interaction_pgnw_bounded_arbitration_seed170_20260820.json"
run_log="outputs/unity_shadow/pgnw_bounded_arbitration_seed170_20260820.jsonl"
...
if [[ -e "$run_memory" || -e "$typed_memory" || -e "$run_log" ]]; then
  print -u2 "Refusing to append: seed-170 arbitration output exists."
  exit 2
fi
