...
run_resource="outputs/resource_memory_pgnw_dual_conflict_seed173_20260820.json"
typed_memory="outputs/typed_interaction_pgnw_dual_conflict_seed173_20260820.json"
metabolic_memory="outputs/typed_metabolic_role_pgnw_dual_conflict_seed173_20260820.json"
run_log="outputs/unity_shadow/pgnw_dual_conflict_seed173_20260820.jsonl"
...
if [[ -e "$run_resource" || -e "$typed_memory" || -e "$metabolic_memory" || -e "$run_log" ]]; then
  print -u2 "Refusing to append: seed-173 dual-conflict output exists."
  exit 2
fi
