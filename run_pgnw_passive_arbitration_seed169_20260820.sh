...
run_memory="outputs/resource_memory_pgnw_passive_arbitration_seed169_20260820.json"
typed_memory="outputs/typed_interaction_pgnw_passive_arbitration_seed169_20260820.json"
run_log="outputs/unity_shadow/pgnw_passive_arbitration_seed169_20260820.jsonl"
...
if [[ -e "$run_memory" || -e "$typed_memory" || -e "$run_log" ]]; then
  print -u2 "Refusing to append: seed-169 arbitration output exists."
  exit 2
fi
