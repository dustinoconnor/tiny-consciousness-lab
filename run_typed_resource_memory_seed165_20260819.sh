...
run_memory="outputs/resource_memory_recall_seed165_treatment_20260819.json"
typed_memory="outputs/typed_interaction_recall_seed165_treatment_20260819.json"
run_log="outputs/unity_shadow/typed_resource_recall_seed165_treatment_20260819.jsonl"
...
if [[ -e "$run_memory" || -e "$typed_memory" || -e "$run_log" ]]; then
  print -u2 "Refusing to append: seed-165 memory treatment already exists."
  exit 2
fi
