...
run_memory="outputs/resource_memory_stale_completion_seed167_20260820.json"
typed_memory="outputs/typed_interaction_stale_completion_seed167_20260820.json"
run_log="outputs/unity_shadow/typed_resource_stale_completion_seed167_20260820.jsonl"
...
if [[ -e "$run_memory" || -e "$typed_memory" || -e "$run_log" ]]; then
  print -u2 "Refusing to append: seed-167 stale-completion output exists."
  exit 2
fi
